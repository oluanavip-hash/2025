              ...
              {sizes.map((size) => {
                ...
                return (
                  <button
                    ...
                    className={`w-20 h-20 rounded-lg border-2 font-semibold transition-all duration-200 flex flex-col items-center justify-center text-center ${
                      isOutOfStock
                  ...
                  >
                    ...
                    <span className={`text-xs mt-1 ${isOutOfStock ? 'text-gray-400' : 'text-gray-500'}`}>
                      {isOutOfStock ? 'Esgotado' : `(${stockQuantity} disp.)`}
                    </span>
                  </button>
                );
              })}
